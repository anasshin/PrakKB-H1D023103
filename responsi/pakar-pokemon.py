...
root = tk.Tk()
root.title("Sistem Pakar Diagnosis Status Abnormal Pokemon")
...
tk.Label(
    mainframe,
    text="Aplikasi Diagnosa Status Abnormal Pokemon",
    font=("Arial", 16)
...
# Inisialisasi Prolog
prolog = Prolog()
prolog.consult("/home/anas/Projek/PrakKB/responsi/pakar-pokemon.pl")
...
def pertanyaan_selanjutnya(ganti_penyakit=False):
    ...
    # Apabila semua gejala dari penyakit habis
